              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ background: '#f9fafb' }}>
                    {['#', 'Passager', 'Trajet', 'Conducteur', 'Date départ', 'Places', 'Prix total', 'Date réservation', 'Statut'].map(h => (
                ...
                <tbody>
                  {filtered.length === 0 ? (
                    <tr>
                      <td colSpan={9} style={{ padding: '50px', textAlign: 'center', color: '#9ca3af', fontSize: '13px' }}>
